...
if (isset($_POST["submit"])){
    ...
    $sql = "UPDATE product SET p_name = '$productName', category = '$category', price ='$price', user_id = '$user_id', image = '$image', quantity = '$quantity', description = '$details' WHERE product_id = '$product_id'";
...
?>
    ...
    <h3 style="text-align: center;">Update Product</h3>
        ...
        <input type="text" list="productName" name="name-of-the-product" id="name-of-the-product" value="<?php echo $fetch['p_name'];?>" required>
            ...
            <input type="text" name="price-of-the-product" id="price-of-the-product" value="<?php echo $fetch['price'];?>" required><br><br>
            <label for="amount-of-the-product">পণ্যের পরিমানঃ  </label>
            <input type="text" name="amount-of-the-product" id="amount-of-the-product" value="<?php echo $fetch['quantity'];?>" required><br><br>
            <label for="details-of-the-product">পণ্যের বিবরণীঃ </label>
            <textarea name="details-of-the-product" id="details-of-the-product" cols="100" rows="3" required><?php echo $fetch['description'];?></textarea>
            <br><br>
